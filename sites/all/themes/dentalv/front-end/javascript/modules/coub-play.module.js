...
const coubBtn = document.getElementsByClassName('coubPlay')[0];
const myCoub = document.getElementById('coubVid').contentWindow;

coubBtn.addEventListener('click', function(){
